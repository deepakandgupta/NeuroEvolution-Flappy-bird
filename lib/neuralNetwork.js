...
class NeuralNetwork {
  constructor(input_nodes, hidden_nodes, output_nodes) {
    if (input_nodes instanceof NeuralNetwork) {
      let xd = input_nodes;
      this.input_nodes = xd.input_nodes;
      this.hidden_nodes = xd.hidden_nodes;
      this.output_nodes = xd.output_nodes;
      this.weights_i_h = xd.weights_i_h.copy();
      this.weights_h_o = xd.weights_h_o.copy();
      this.bias_h = xd.bias_h.copy();
      this.bias_o = xd.bias_o.copy();
    } else {
  ...
  mutate(rate) {
    ...
    this.weights_h_o.map(mutate);
    this.weights_i_h.map(mutate);
